...
class CobranzaDrawer extends StatefulWidget {
  const CobranzaDrawer({
    Key key,
  ...
  @override
  _CobranzaDrawerState createState() => _CobranzaDrawerState();
}

class _CobranzaDrawerState extends State<CobranzaDrawer>
